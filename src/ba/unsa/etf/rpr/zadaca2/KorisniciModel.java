...
public class KorisniciModel {
    ...
    public Korisnik getTrenutniKorisnik() {
        if(trenutniKorisnik.get() instanceof Administrator) return (Administrator) trenutniKorisnik.get();
    ...
    public void setTrenutniKorisnik(Korisnik trenutniKorisnik) {
        ...
        trenutniKorisnik.setPasswordRepeat(trenutniKorisnik.getPassword());
